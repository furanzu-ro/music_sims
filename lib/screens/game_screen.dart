          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    _profilePicture.isEmpty ? 'Select Profile Picture (Optional)' : _profilePicture.split('/').last,
                          ...
                          const Text(
                            ...
                            _buildFormField(
                              ...
                              validator: (value) {
                                ...
                                if (year == null || year < 1900 || year > DateTime.now().year) return 'Please enter a valid year';
                                return null;
                              },
                              onSaved: (value) => _startingYear = int.tryParse(value ?? DateTime.now().year.toString()) ?? DateTime.now().year,
                            ),
                            const SizedBox(height: 12),
    ...
    return Container(
      ...
      child: TextFormField(
        decoration: InputDecoration(
          labelText: label,
          labelStyle: TextStyle(color: Colors.white.withOpacity(0.85), fontSize: fontSize),
